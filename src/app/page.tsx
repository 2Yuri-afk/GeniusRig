...
const features = [
  {
    ...
    description: "Advanced machine learning algorithms analyze thousands of component combinations to find your perfect build.",
    color: "from-yellow-400 to-orange-500"
  },
  {
    icon: Target,
    title: "Precision Matching",
    description: "Get components that perfectly match your use case, whether gaming, content creation, or productivity.",
    color: "from-blue-400 to-purple-500"
  },
  {
    icon: TrendingUp,
    title: "Budget Optimization",
    description: "Maximize performance per dollar with intelligent budget allocation across all components.",
    color: "from-green-400 to-blue-500"
  },
  {
    icon: Shield,
    title: "Compatibility Guaranteed",
    description: "Every recommendation is verified for compatibility, ensuring your build works flawlessly.",
    color: "from-purple-400 to-pink-500"
  },
  {
    icon: Clock,
    title: "Real-time Pricing",
    description: "Get up-to-date market prices and availability information for all recommended components.",
    color: "from-pink-400 to-red-500"
  },
  {
    icon: Monitor,
    title: "Performance Insights",
    description: "Understand exactly what performance to expect from your build across different applications.",
    ...
    <div className="relative overflow-hidden">
      ...
      <section className="relative min-h-screen flex items-center justify-center -mt-16">
        ...
        <div className="absolute inset-0 overflow-hidden">
          ...
          <div className="absolute top-3/4 right-1/4 w-96 h-96 bg-accent/5 rounded-full blur-3xl floating-animation" style={{ animationDelay: '2s' }} />
        </div>
        ...
        <div className="container mx-auto px-4">
          <div className="text-center space-y-4 mb-16">
            ...
            <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
              Experience the future of PC building with intelligent recommendations and seamless optimization.
            </p>
          </div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="text-center space-y-8 max-w-3xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground">
              Join thousands of satisfied builders who trust our AI to create their ideal setup.
            </p>
